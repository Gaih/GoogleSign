...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            //绑定ServiceConnection到IInAppBillingService 只要支持billing v3 就会返回成功
            @Override
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                buyIntentBundle = mService.getPurchases(5, mContext.getPackageName(),
                        itemType, extraData);
            }
    ...
    void checkSetupDone(String operation) {
        if (!mSetupDone) {
            Toast.makeText(mContext,"계정에 이상이 있습니다, 재 로그인 하세요", Toast.LENGTH_LONG).show();
            return;
